...
function saludo(idioma) {
   ...
   return idioms.find((i) => i.idiom === idioma)?.frase || 'Hola!'
...
function colors(color) {
   ...
   return (typeof colorSelector[color] === 'string') ? colorSelector[color] : "Color not found"
...
function operadoresLogicos(num1, num2, num3) {
   ...
   if (numbersArray.find((i) => i < 0)) return "Hay negativos"
